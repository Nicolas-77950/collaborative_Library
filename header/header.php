    ...
    <header class="bg-blue-600 text-white p-4 shadow-md">
        <div class="container mx-auto flex justify-between items-center">
            <h1 class="text-2xl font-bold">
                <a href="/Projet_Web/collaborative_Library/www/index.php">Collaborative Library</a>
            </h1>
                
            <nav>
                <ul class="flex space-x-4">
                    <li><a href="/Projet_Web/collaborative_Library/www/index.php" class="hover:underline">Accueil</a></li>
